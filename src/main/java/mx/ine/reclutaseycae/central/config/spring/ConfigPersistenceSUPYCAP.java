...
@EnableJpaRepositories(
		...
		entityManagerFactoryRef = "supycapEntityManagerFactory",
		transactionManagerRef = "supycapTransactionManager")
public class ConfigPersistenceSUPYCAP {
     ...
     */
    @Autowired
    public ConfigPersistenceSUPYCAP(Environment environment,
     ...
     */
//    @Bean()    
    private DataSource supycapDataSource() {
        JndiDataSourceLookup dataSourceLookup = new JndiDataSourceLookup();
        return dataSourceLookup.getDataSource(environment.getProperty("dataSource.jndiNameSUPYCAP"));
    }
     ...
     */
    @Bean
    public PlatformTransactionManager supycapTransactionManager() {
     ...
     */
    @Bean
    public LocalContainerEntityManagerFactoryBean supycapEntityManagerFactory() {
        LocalContainerEntityManagerFactoryBean emf = new LocalContainerEntityManagerFactoryBean();
       
        emf.setJpaVendorAdapter(jpaVendorAdapter);
        emf.setPersistenceProviderClass(HibernatePersistenceProvider.class);
        emf.setPersistenceUnitName("supycapPU");
        emf.setSharedCacheMode(SharedCacheMode.ENABLE_SELECTIVE);
        emf.setJtaDataSource(supycapDataSource());
